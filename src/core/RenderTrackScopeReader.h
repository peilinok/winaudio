...
class RenderTrackScopeReader final : public ScopeReader {
public:
    RenderTrackScopeReader(const RenderTrackList& list, TrackId id) : list_(list), id_(id) {}
