...
inline constexpr const char* kMmsysCpl = "mmsys.cpl";
inline constexpr const char* kMsSettings = "ms-settings";
inline constexpr const char* kMmsysCplFailed = "mmsys.cpl: ShellExecute failed";
inline constexpr const char* kMsSettingsFailed = "ms-settings: ShellExecute failed";
